...
void loop() {
  if (sys_ready) {
    ...
    servo_val[0] = -target_pos4 / 1.4 + (servo_off[0] - 90);
    servo_val[1] = target_pos5 / 1.0 + (servo_off[1] - 90);
    servo_val[2] = (2 * target_pos6 - target_pos7 + 1.5 * servo_val[1]) / 2.0 + (servo_off[2] - 90);
    servo_val[3] = (target_pos7 / 1.0) + servo_val[2] + (servo_off[3] - 90);
